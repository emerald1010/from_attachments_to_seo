...
parser.add_argument('--clusters_file', default='exp9_folder/clusters', type=str, metavar='PATH',
                        help='path to the clusters file')
#dir path to save the filenames
parser.add_argument('--saved_filehashes_dir', default='exp9_folder/filehashes_per_clusters/', type=str, metavar='PATH',
